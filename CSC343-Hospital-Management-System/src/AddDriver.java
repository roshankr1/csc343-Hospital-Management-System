...
public class AddDriver extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            rs=stat.executeQuery("Select count(*) from Driver");
            int count=0;
            if(rs.next())
            {
            ...
            count++;
            int status=stat.executeUpdate("insert into Driver values('D"+count+"','"+driverName+"','"+dl+"','"+address+"','"+contact+"')");
            JOptionPane.showMessageDialog(rootPane, "Successfully Added Driver in Database. Driver Id is D"+count+".");
//            jButton3.doClick();
            jTextField1.setText("D"+count);
        }
        catch(Exception e)
        {
