...
public class EditInventory extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            stat.executeUpdate("Delete from Inventory where ItemId='"+id+"'");
            int status=stat.executeUpdate("insert into Inventory values('"+id+"','"+driverName+"','"+dl+"')");
            JOptionPane.showMessageDialog(rootPane, "Successfully Updated Item in Database.");
        }
        catch(Exception e)
        {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
            myConn=DriverManager.getConnection("jdbc:mysql://localhost:3306/HMS_0049",Info.user,Info.pass);
            stat=myConn.createStatement();
            rs=stat.executeQuery("Select * from Inventory where ItemId='"+id+"'");
            if(rs.next())
            {
            ...
            {
                JOptionPane.showMessageDialog(rootPane,"No Item found with the given Item id.");
            }
        }
        catch(Exception e)
        {
