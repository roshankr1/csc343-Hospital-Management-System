 ...
 * @author pratik
 */
public class ShowAppointmentsDoc extends javax.swing.JFrame {

    /**
     * Creates new form ShowAppointmentsDoc
     */
    public ShowAppointmentsDoc() {
        initComponents();
    }
    ...
    private void showBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showBtnActionPerformed
        ...
        try
        {
            ...
            String query="Select concat(Patient.FirstName,' ',Patient.LastName),concat(Staff.FirstName,' ',Staff.LastName),Time,Status,Duration from Appointment,Patient,Staff where Date='"+date+"' and Patient.Id=Appointment.PatientId and Staff.Id=Appointment.StaffId and Appointment.StaffId='"+Info.UserId+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowAppointmentsDoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
